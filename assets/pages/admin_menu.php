                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-x-5"> <?php 
                            ...
                            <div class="w-full flex flex-row items-center justify-between gap-x-1.5 mt-2">
                                <form action="../php/action.php" method="post" class="w-1/2">
                                    ...
                                    <button type="submit" name="admin_menu_edit" class="w-full border-2 border-green-800 bg-green-800 text-white px-4 py-1 text-center rounded-full transform hover:scale-105 transition-all duration-500">Edit</button>
                                </form>
                                <form action="../php/action.php" method="post" class="w-1/4">
                                    ...
                                    <input type="hidden" name="menu_id" value="
														<?php echo $menu_id?>">
                                    <button type="submit" name="admin_disable" class="w-full flex flex-row items-center justify-center font-bold p-2 border-2 <?php echo $rows['disable'] == 'yes' ? 'border-green-800 bg-green-800' : 'border-red-700 bg-red-700'; ?> text-white px-2 py-1 text-center rounded-full transform hover:scale-105 transition-all duration-500">
                                        <input type="hidden" name="disabled" value="<?php echo $rows['disable'] == 'no' ? 'yes' : 'no'; ?>">
                                        <?php if($rows['disable'] == 'yes'){?>
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <div id="modalBox1" class="bg-white w-3/4 lg:w-1/3 mx-auto p-10 rounded-lg text-center animate__animated animate__bounceInDown shadow-2xl">
                                        ...
                                        <div class="flex flex-row items-center justify-center gap-5">
                                            <form action="../php/action.php" method="post">
                                                ...
                                                <button type="submit" name="admin_delete" class="bg-green-800 text-white px-10 py-3 rounded-md">Yes</button>
                                            </form>
                                            <div href="admin_menu.php?token=
																				<?php echo $_GET['token'];?>" onclick="cancel1()" class="bg-red-800 text-white px-10 py-3 rounded-md cursor-pointer">Cancel </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="w-full my-10">
                <div id="drinksContent" class="hidden">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-x-5"> <?php                    
                                                ...
                                                ?> <div class="my-5 w-full group">
                            <div class="shadow-lg relative w-full h-auto rounded-lg transform hover:scale-105 overflow-hidden transition-all duration-500">
                                <img class="w-full h-auto" src="../images/<?php echo $rows['thumbnail'];?>">
                                <div class="absolute right-1 top-1 flex flex-row space-x-2">
                                    <?php if($rows['disable'] == 'yes'){ ?>
                                        <div class="px-2 py-1 bg-red-600 text-white text-xs rounded-full">
                                            <p>Disabled</p>
                            ...
                            <div class="w-full flex flex-row items-center justify-between gap-x-1.5 mt-2">
                                ...
                                <form action="../php/action.php" method="post">
                                    ...
                                    <input type="hidden" name="menu_id" value="
																										<?php echo $rows['id']; ?>">
                                    <button type="submit" name="admin_delete" class="w-full flex flex-row items-center justify-center font-bold p-2 border-2 border-black bg-black text-white px-2 py-1 text-center rounded-full transform hover:scale-105 transition-all duration-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                        </svg>
                                    </button>
