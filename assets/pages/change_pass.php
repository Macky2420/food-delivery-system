...
<div class="col-span-3 lg:col-span-1 shadow-2xl w-full flex flex-col items-center justify-center p-5 bg-white rounded-none lg:rounded-r-3xl">
    ...
    <form autocomplete="off" action="" method="post" class="w-full flex flex-col items-center">

  
        <div class="space-y-3 w-3/5 mb-4">
            <p class="font-semibold">Enter your New Password</p>
            <input type="password" placeholder="New Password" name="code"  class="focus:outline-none border-3 border-gray-400 focus:border-green-500 rounded-lg p-2 w-full" required> <!--border-red-500 bg-red-200-->
            
                <!-- <p class="text-xs text-red-500">wrong email</p> -->
          
        </div>
        <div class="space-y-3 w-3/5 mb-4">
            <p class="font-semibold">Repeat Password</p>
            <input type="password" placeholder="Repeat Password" name="code"  class="focus:outline-none border-3 border-gray-400 focus:border-green-500 rounded-lg p-2 w-full" required> <!--border-red-500 bg-red-200-->
            
                <!-- <p class="text-xs text-red-500">wrong email</p> -->
          
        </div>
                <!-- Next it can be Submit and remove the a tag -->
        <button type="button" class="rounded-2xl flex flex-row items-center justify-center space-x-2 py-3 w-3/5 bg-green-800 hover:bg-green-600 text-white font-bold mt-4 transform hover:scale-105 transition duration-500">
          <a href="login.php"><p>Submit</p></a>
      </button>
