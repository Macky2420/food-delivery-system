...
<div class="col-span-3 lg:col-span-1 shadow-2xl w-full flex flex-col items-center justify-center p-5 bg-white rounded-none lg:rounded-r-3xl">
    ...
    <form autocomplete="off" action="../php/action.php" method="post" class="w-full flex flex-col items-center">
        ...
        <div class="space-y-3 w-3/5 mb-4">
            <p class="font-bold text-2xl text-green-900">New Password</p>
        </div>
        ...
        <button type="submit" name="new_pass" class="rounded-2xl flex flex-row items-center justify-center space-x-2 py-3 w-3/5 bg-green-800 hover:bg-green-600 text-white font-bold mt-4 transform hover:scale-105 transition duration-500">
          <p>Submit</p>
      </button>
