    ...
    <div class="ml-16 w-full min-h-screen overflow-hidden text-green-800">
        <div class="p-10">
            ...
            <div class="flex flex-row items-center text-sm my-10">
                <a href="admin_home.php?token=<?php echo $token; ?>" class="font-bold hover:text-blue-800">Home</a>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
                <a href="admin_menu.php?token=
            ...
            <form action="../php/action.php" method="post" enctype="multipart/form-data">
                ...
                <div class="lg:w-1/2 grid grid-cols-2 gap-x-5 gap-y-8 mb-20">
                    ...
                    <button type="submit" name="admin_edit_create" class="border-3 hover:border-green-700 border-green-800 hover:bg-green-700 bg-green-800 text-white py-4 rounded-lg font-bold transition-all duration-500 transform hover:scale-105">
                        <p>Confirm Edit</p>
                    </button>
                    <a href="admin_menu.php?token=<?php echo $token; ?>" class="border-3 hover:border-red-700 border-red-800 hover:bg-red-700 bg-red-800 text-white py-4 rounded-lg text-center font-bold transition-all duration-500 transform hover:scale-105"> Cancel</a>
                </div>
            </form>
        </div>
    </div>
