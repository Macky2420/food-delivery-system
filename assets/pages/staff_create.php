            ...
            <form action="../php/action.php" method="post" enctype="multipart/form-data">
                ...
                <div class="lg:w-1/2 grid grid-cols-2 gap-x-5 gap-y-8 mb-20">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" name="name" maxlength="16" class="w-full mt-3 p-2 border-3 border-green-800 focus:outline-none focus:border-green-500 rounded-lg" value="" required>
                    </div>
                    <div class="col-span-1">
                        ...
                        <label class="w-full mt-3 flex flex-row items-center border-3 border-green-800 rounded-lg p-0.5">
                            ...
                            <input id="upload-input" name="image" class="hidden" placeholder="Select a file" type="file" value="" accept="image/*" onchange="getFileName()">
                        </label>
                        <script>
                    ...
                    <div class="col-span-2 w-full" id="dynamicAddRemove">
                        ...
                        <div class="flex flex-row items-end space-x-4 mb-3 w-full">
                            <div class="w-full">
                                ...
                                <input type="text" name="optionName[]" class="w-full mt-3 p-2 border-3 border-green-800 focus:outline-none focus:border-green-500 rounded-lg" value="" required>
                            </div>
                            <div class="w-full">
                                <p class="text-sm font-bold">Price (PHP)</p>
                                <input type="number" min="1" step="any" name="optionPrice[]" class="w-full mt-3 p-2 border-3 border-green-800 focus:outline-none focus:border-green-500 rounded-lg" value="" required>
                            </div>
                    ...
                    <button type="submit" name="confirm_create" class="border-3 hover:border-green-700 border-green-800 hover:bg-green-700 bg-green-800 text-white py-4 rounded-lg font-bold transition-all duration-500 transform hover:scale-105">
                        <p>Confirm Create</p>
                    </button>
